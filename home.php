...
<head>
    ...
    <meta name="description" 
         content="Discover cutting-edge electronics and tech gadgets at PowerPulse 
         Shop the latest in smartphones, laptops, smart home devices, and more. 
         Find unbeatable deals on high-quality electronics to power up your life. Shop now">
...
<?php
/*// Check if the "remembered_user" cookie is set
if (isset($_COOKIE["remembered_user"])) {
   // Split the cookie value into email and username
   //list($email, $username) = explode('|', $_COOKIE["remembered_user"]);

   // Display the welcome message
  // echo "Welcome back, $username!";
   //echo "<script>alert('Welcome back, $username');</script>"; /// add welcome
